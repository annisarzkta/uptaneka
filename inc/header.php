<nav class="navbar navbar-expand-lg navbar-lightblue bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
      <a class="navbar-brand me-5 fw-bold fs-3" href="index.php">
        <img src="assets/logo.svg" alt="Logo" width="50" height="40" class="d-inline-block align-text-center">
          UPT ANEKA
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="d-flex">
          <button type="button" class="btn btn-primary shadow-none me-lg-3 me-3" data-bs-toggle="modal" data-bs-target="#loginModal">
              Login
          </button>
